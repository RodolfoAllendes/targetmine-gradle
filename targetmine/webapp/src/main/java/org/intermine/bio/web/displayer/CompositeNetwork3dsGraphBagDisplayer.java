 ...
 * @version 0.1
 */
public class CompositeNetwork3dsGraphBagDisplayer extends BagDisplayer{
  /* define a LOG to post messages to */
  protected static final Logger logger = Logger.getLogger(CompositeNetwork3dsGraphBagDisplayer.class);

  /**
   * Constructor
   * Use super class to initialize required components
   */
  public CompositeNetwork3dsGraphBagDisplayer(ReportDisplayerConfig config, InterMineAPI im){
    super(config,im);
  }
