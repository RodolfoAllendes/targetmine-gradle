...
<c:if test="${pageName != 'begin'}">
  ...
  <c:if test="${pageName != 'report' && pageName != 'mymine' && pageName != 'bagDetails' && pageName != 'results' && pageName != 'bagUploadConfirm' && pageName != 'compositeNetwork'}">
...
<!-- print stylesheet -->
<c:if test="${pageName == 'bagDetails' || pageName == 'results' || pageName == 'compositeNetwork'}">
